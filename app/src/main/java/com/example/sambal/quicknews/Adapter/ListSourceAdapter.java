package com.example.sambal.quicknews.Adapter;
...
import com.example.sambal.quicknews.Interface.ItemClickListener;
import com.example.sambal.quicknews.ListNews;
import com.example.sambal.quicknews.Model.IconBetterIdea;
import com.example.sambal.quicknews.Model.WebSite;
import com.example.sambal.quicknews.R;
...
//                            Toast.makeText(ListSourceAdapter.this, "", Toast.LENGTH_LONG).show();
                        }
                    }
...
//                intent.putExtra("sortBy", webSite.getSources().get(position).getSortBysAvailable().get(0));
                intent.putExtra("sortby", "top");//get default sort by method
